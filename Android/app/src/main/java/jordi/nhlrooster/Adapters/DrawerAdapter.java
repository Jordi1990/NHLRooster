...
public class DrawerAdapter extends RecyclerView.Adapter<DrawerAdapter.ViewHolder> {
    ...
    private int mNavTitles[]; // String Array to store the passed titles Value from MainActivity.java
    private int mIcons[];
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView,int ViewType, Context c) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                ...
                Name = (TextView) itemView.findViewById(R.id.appName);         // Creating Text View object from header.xml for name
    ...
    public DrawerAdapter(int Titles[], int Icons[], Context passedContext){
        mNavTitles = Titles;
        mIcons = Icons;
